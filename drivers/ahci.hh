...
private:
    ...
    memory::phys_ptr<cmd_list[]> _cmd_list = memory::make_phys_array<cmd_list>(32, sizeof(cmd_list)*32);
    memory::phys_ptr<cmd_table[]> _cmd_table = memory::make_phys_array<cmd_table>(32, 128);
