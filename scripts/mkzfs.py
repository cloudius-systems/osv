...
osv = subprocess.Popen('cd ../..; scripts/run.py --vnc none -c1 -m 512 -i %s -u -s -e "--nomount --norandom tools/mkfs.so; tools/cpiod.so --prefix /zfs/zfs" --forward tcp:10000::10000' % image_path, shell = True, stdout=subprocess.PIPE)
