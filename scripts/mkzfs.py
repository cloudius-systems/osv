...
osv = subprocess.Popen('cd ../..; scripts/run.py -c1 -i %s -u -g -e "--nomount tools/mkfs.so; tools/cpiod.so --prefix /zfs/zfs" --forward tcp:10000::10000' % image_path, shell = True, stdout=subprocess.PIPE)
