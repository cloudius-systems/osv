...
public:
     ...
     */
    client& upload(const std::string& server, const std::string& path, unsigned int port, const std::string& file_name, const std::string& dir, const std::string& content);
