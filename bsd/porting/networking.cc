...
// a Managed-flag DHCPv6 network (which sends RAs), QEMU SLIRP ipv6=on, and QEMU/Firecracker tap
...
// SLAAC? A Managed-flag network sets this. Returns false if the interface is unknown.
